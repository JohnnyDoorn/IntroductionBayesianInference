...
-   JASP file with only the results: [OSF](https://osf.io/snu9r/)
-   JASP file with results and interpretation/solutions: [OSF](https://osf.io/273yp/)
...
-   csv file with the data: [OSF](https://osf.io/zh9md/)
-   JASP file with only the results: [OSF](https://osf.io/azkvc/)
-   JASP file with results and interpretation/solutions: [OSF](https://osf.io/jn3es/)
...
-   JASP file with only the results: [OSF](https://osf.io/xs9dq/)
-   JASP file with results and interpretation/solutions: [OSF](https://osf.io/5fq6s/)
...
-   JASP file with only the results: [OSF](https://osf.io/85fbv/)
-   JASP file with results and interpretation/solutions: [OSF](https://osf.io/3qgnc)
...
-   csv file with the data: [OSF](https://osf.io/zh9md/)
-   JASP file with only the results: [OSF](https://osf.io/xjdyt/)
-   JASP file with results and interpretation/solutions: [OSF](https://osf.io/rmdac)
...
-   JASP file with only the results: [OSF](https://osf.io/tm6us/)
-   JASP file with results and interpretation/solutions: [OSF](https://osf.io/3f47y/)
